from src.genetic_algorithm_files.score_pop import score_pop
from src.genetic_algorithm_files.selection import selection


def create_result(
    population, paver, generation, crossover, parent, select, mutation=None, mutation_chance=0.1, output_file=None
):
