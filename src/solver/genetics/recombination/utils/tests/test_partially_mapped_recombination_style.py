...
# sad_params: TestParameters = [TestCase(id="", data=RecombinationStyleTestData())]
...
# def sad_paths(parent_1: InPath, parent_2: InPath, detour_1: int, detour2: int, expected: Exception) -> None:
#     pass
